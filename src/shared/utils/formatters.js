/**
 * Shared formatting utilities for both backend and frontend
 * This mirrors the frontend formatters but uses CommonJS exports for Node.js compatibility
 */

const formatCurrency = (amount, currency = 'AUD', locale = 'en-AU') => {
...
const formatTransactionDescription = (description, maxLength = 50) => {
